...
const CACHE = "kalku-v15";
const ASSETS = ["./", "./index.html", "./ux.css", "./ux.js", "./universe.js", "./universe.css", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
