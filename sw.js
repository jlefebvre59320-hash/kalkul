...
const CACHE = "kalku-v18";
const ASSETS = ["./", "./index.html", "./ux.css", "./ux.js", "./universe.js", "./universe.css", "./arcade.js", "./arcade.css", "./mobile.js", "./mobile.css", "./realms.js", "./realms.css", "./manifest.webmanifest", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png"];
